...
Automated weekly reporting for **200+ international clients** using Python, Pandas, Google Sheets & Apps Script — saving hours of manual work per client per week.

`Python` `Pandas` `Google Sheets` `Apps Script` `Automation`
...
- 🎨 Designed brand assets, promotional graphics, and AI-generated content at scale
- 📈 Full-cycle digital marketing: SEO, social media, content creation, web management
...
- 🍦 Supported SLAP Ice Cream's brand launch and expansion to **6 branches across Lahore**
- 🛠️ Contributed to brand strategy, website development, and launch planning
...
- 🎯 Ran targeted organic and paid campaigns for student enrollment outreach
...
**Leadership:**
- 🎬 Vice President, Media Society (Pixels) — NIIT
- ✍️ Head of Communications, Literary Society — NIIT

**Certifications:**
- 📜 Digital Marketing Certification — Peak Solutions College *(SEO, Google Ads, Social Media, Content Marketing)*
...
- 🌱 **Community Development Volunteer** — Bunyaad Pakistan *(Jan 2025)*
  - Organized educational workshops for underprivileged students
- ❤️ **Fundraising Coordinator** — Al Khidmat Foundation / Waduha Foundation *(2023–2024)*
  - Organized Iftar drives and fundraising campaigns for humanitarian causes
